...
pytest.importorskip("pytui.lib.renderable_validations")
...
class TestValidation:
    ...
    def test_validate_positive_int_ok(self):
        from pytui.lib.renderable_validations import validate_positive_int
    ...
    def test_validate_non_negative_int_ok(self):
        from pytui.lib.renderable_validations import validate_non_negative_int
    ...
    def test_validate_hex_color_ok(self):
        from pytui.lib.renderable_validations import validate_hex_color
